...
const files = ref([
    { id: 1, name: 'presupuesto_2026.pdf', size: '2.4 MB', type: 'PDF', updated: 'hace 2 horas' },
    { id: 2, name: 'foto_servidor.jpg', size: '4.1 MB', type: 'Imagen', updated: 'ayer' },
    { id: 3, name: 'configuracion_docker.txt', size: '12 KB', type: 'Texto', updated: 'hace 3 días' },
]);
</script>
            ...
            <section>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div 
                        ...
                        :key="folder.id"
                        class="p-4 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl hover:border-indigo-500/50 hover:shadow-md transition-all cursor-pointer group"
                    >
                ...
                <div class="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden shadow-sm">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-800">
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            <tr v-for="file in files" :key="file.id" class="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors group cursor-pointer">
